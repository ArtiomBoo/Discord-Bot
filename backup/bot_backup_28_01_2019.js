    ...
    if(newMember.presence.game){
      ...
      if(`${game}` == "PLAYERUNKNOWN'S BATTLEGROUNDS" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          if(!newMember.roles.find("name", "PUBG") && !newMember.roles.find("name", "- PUBG")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'PUBG'));
          newMember.addRole(newMember.guild.roles.find('name', '- PUBG'));
          console.log("- Main Role (PUBG) added to " + newMember.user.username);
      ...
      if(`${game}` == "League of Legends" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "League of Legends") && !newMember.roles.find("name", "- League of Legends")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'League of Legends'));
          newMember.addRole(newMember.guild.roles.find('name', '- League of Legends'));
          console.log("- Main Role (League of Legends) added to " + newMember.user.username);
      ...
      if(`${game}` == "Counter-Strike Global Offensive" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "CS:GO") && !newMember.roles.find("name", "- CS:GO")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'CS:GO'));
          newMember.addRole(newMember.guild.roles.find('name', '- CS:GO'));
          console.log("- Main Role (CS:GO) added to " + newMember.user.username);
      ...
      if(`${game}` == "DOTA 2" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "Dota 2") && !newMember.roles.find("name", "- Dota 2")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'Dota 2'));
          newMember.addRole(newMember.guild.roles.find('name', '- Dota 2'));
          console.log("- Main Role (Dota 2) added to " + newMember.user.username);
      ...
      if(`${game}` == "Russian Fishing 4" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "Russian Fishing 4") && !newMember.roles.find("name", "- Russian Fishing 4")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'Russian Fishing 4'));
          newMember.addRole(newMember.guild.roles.find('name', '- Russian Fishing 4'));
          console.log("- Main Role (Russian Fishing 4) added to " + newMember.user.username);
      ...
      if(`${game}` == "Destiny 2" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "Destiny 2") && !newMember.roles.find("name", "- Destiny 2")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'Destiny 2'));
          newMember.addRole(newMember.guild.roles.find('name', '- Destiny 2'));
          console.log("- Main Role (Destiny 2) added to " + newMember.user.username);
      ...
      if(`${game}` == "Overwatch" ){
        ...
        if(newMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!newMember.roles.find("name", "Overwatch") && !newMember.roles.find("name", "- Overwatch")){
          ...
          newMember.addRole(newMember.guild.roles.find('name', 'Overwatch'));
          newMember.addRole(newMember.guild.roles.find('name', '- Overwatch'));
          console.log("- Main Role (Overwatch) added to " + newMember.user.username);
    ...
    if(oldMember.presence.game){
      ...
      if(`${game}` == "PLAYERUNKNOWN'S BATTLEGROUNDS" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "PUBG") && !oldMember.roles.find("name", "- PUBG")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'PUBG'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- PUBG'));
          console.log("- Main Role (PUBG) added to " + oldMember.user.username);
      ...
      if(`${game}` == "League of Legends" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "League of Legends") && !oldMember.roles.find("name", "- League of Legends")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'League of Legends'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- League of Legends'));
          console.log("- Main Role (League of Legends) added to " + oldMember.user.username);
      ...
      if(`${game}` == "Counter-Strike Global Offensive" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "CS:GO") && !oldMember.roles.find("name", "- CS:GO")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'CS:GO'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- CS:GO'));
          console.log("- Main Role (CS:GO) added to " + oldMember.user.username);
      ...
      if(`${game}` == "DOTA 2" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "Dota 2") && !oldMember.roles.find("name", "- Dota 2")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'Dota 2'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- Dota 2'));
          console.log("- Main Role (Dota 2) added to " + oldMember.user.username);
      ...
      if(`${game}` == "Russian Fishing 4" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "Russian Fishing 4") && !oldMember.roles.find("name", "- Russian Fishing 4")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'Russian Fishing 4'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- Russian Fishing 4'));
          console.log("- Main Role (Russian Fishing 4) added to " + oldMember.user.username);
      ...
      if(`${game}` == "Destiny 2" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "Destiny 2") && !oldMember.roles.find("name", "- Destiny 2")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'Destiny 2'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- Destiny 2'));
          console.log("- Main Role (Destiny 2) added to " + oldMember.user.username);
      ...
      if(`${game}` == "Overwatch" ){
        ...
        if(oldMember.roles.find("name", "PUBG") ||
          ...
          //either main or secondary
          if(!oldMember.roles.find("name", "Overwatch") && !oldMember.roles.find("name", "- Overwatch")){
          ...
          oldMember.addRole(oldMember.guild.roles.find('name', 'Overwatch'));
          oldMember.addRole(oldMember.guild.roles.find('name', '- Overwatch'));
          console.log("- Main Role (Overwatch) added to " + oldMember.user.username);
